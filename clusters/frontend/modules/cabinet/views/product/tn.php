...
<?= $this->render("../layouts/_nav", [
    ...
    'btn_url' => toRoute('/cabinet/product/add-tn'),
]) ?>
            ...
            <div class="col-md-9">
                <ul class="nav nav-cabinet fs-15">
                    <li class="nav-item position-relative pb-30 mr-15">
                        <a class="nav-link p-0" href="<?= toRoute('/cabinet/product') ?>">
                    ...
                    <li class="nav-item position-relative pb-30 mx-15">
                        <a class="nav-link p-0" href="<?= toRoute('/cabinet/product/archive') ?>">
                            <?= t("Продукты в архиве") ?> (<?= isset($counts[Product::STATUS_INACTIVE]) ? $counts[Product::STATUS_INACTIVE] + 0 : 0 ?>)
                        </a>
                    </li>
                    <li class="nav-item position-relative pb-30 mx-15">
                        <a class="nav-link p-0" href="<?= toRoute('/cabinet/product/moderating') ?>">
                    ...
                    <li class="nav-item position-relative pb-30 mx-15">
                        <a class="nav-link p-0" href="<?= toRoute('/cabinet/product/not-moderated') ?>">
                            <?= t("Не прошел модерацию") ?> (<?= isset($counts[Product::STATUS_NOT_MODERATED]) ? Product::STATUS_NOT_MODERATED + 0 : 0 ?>)
                        </a>
                    </li>
                    <li class="nav-item position-relative  pb-30 mx-15">
                        <a class="nav-link p-0 active" href="<?= toRoute('/cabinet/product/tn') ?>">
                                ...
                                <div class="item shadow bg-white rounded mb-10 wow fadeInUp">
                                    <div class="item__head py-15 px-20 ">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col pl-15">
                                                <a class="btn btn-outline-secondary mb-3 px-10 py-1 fs-13" href="<?= toRoute('/cabinet/product/update-tn/' . $product->id) ?>">
                                                    <i class="icon-edit mr-2"></i><?= t('Редактировать') ?>
                                                </a>
                                                <a class="btn btn-outline-danger mb-3 px-10 py-1 fs-13" href="<?= toRoute('/cabinet/product/delete-tn/' . $product->id) ?>" data-method="POST" data-confirm="<?= t('Вы уверены?') ?>">
