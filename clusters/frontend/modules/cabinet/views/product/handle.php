...
$this->params['breadcrumbs'][] = array(
    'label' => t("Мои товары"),
    'url' => toRoute('/cabinet/product')
);
$this->params['breadcrumbs'][] = $this->title;

$class_disabler = $model->status == Product::STATUS_ACTIVE || $model->status == Product::STATUS_INACTIVE ? 'disabled' : null;
?>
                ...
                <div class="cabinet__content shadow">
                    <ul class="nav nav-cabinet product-tab fs-15" id="pills-tab" role="tablist">
                        <li class="nav-item position-relative pb-30 mr-15 ">
                            <a class="nav-link p-0  <?=$class_disabler ? $class_disabler : 'active'?>" id="pill-1-tab" data-toggle="tab" href="#pill-1" role="tab" aria-controls="pill-1">
                                <?= t("Основные данные") ?> <i class="fa fa-exclamation"></i>
                            </a>
                        </li>
                        <li class="nav-item position-relative  pb-30 mx-15">
                            <a class="nav-link p-0 <?=$class_disabler?>" data-toggle="tab" id="pill-2-tab" href="#pill-2" role="tab" aria-controls="pill-2">
                                <?= t("Характеристики") ?> <i class="fa fa-exclamation"></i>
                            </a>
                        </li>
                        <li class="nav-item position-relative  pb-30 mx-15">
                            <a class="nav-link p-0 <?=$class_disabler ? 'active' : ''?> " data-toggle="tab" href="#pill-3" role="tab" aria-controls="pill-3">
                                <?= t("Цены и количество") ?> <i class="fa fa-exclamation"></i>
                            </a>
                        </li>
                        <li class="nav-item position-relative  pb-30 mx-15">
                            <a class="nav-link p-0 <?=$class_disabler?>" data-toggle="tab" href="#pill-4" role="tab" aria-controls="pill-4">
                                <?= t("Доставка") ?> <i class="fa fa-exclamation"></i>
                            </a>
                        </li>
                        <li class="nav-item position-relative  pb-30 mx-15">
                            <a class="nav-link p-0 <?=$class_disabler?>" data-toggle="tab" href="#pill-5" role="tab" aria-controls="pill-5">
                        ...
                        <div class="col-md-12 col-xxl-12">
                            <div class="rounded bg-white p-20 fs-15">
                                ...
                                <div class="tab-content pb-15" id="pills-tabContent">
                                    <div class="tab-pane font-family-roboto fade <?=$class_disabler ? '' : 'show active'?>" id="pill-1" role="tabpanel" aria-labelledby="pill-1-tab">
                                        <div class="form-group mb-25">
                                            <?= $form->field($model, 'category_id')->dropDownList(
                                                $model->category ? [$model->category->id => $model->category->title] : [],
                                                [
                                                    'class' => 'form-control parent-category-ajax px-15',
                                                    'prompt' => t(" - Выберите - ")
                                                ]
                                            ) ?>
                                        </div>
                                        <div class="form-group mb-25">
                                            <?= $form->field($model, 'tovar_id')->dropDownList(
                                                $model->tovar ? [$model->tovar->id => $model->tovar->title] : [],
                                                [
                                                    'class' => 'form-control tovar-category-ajax px-15',
                                                    'prompt' => t(" - Выберите - ")
                                                ]
                                            ) ?>
                                        </div>
                                        <!-- <div class="form-group mb-25">
                                            <?= $form->field($model, 'title')->input('text', [
                                                'class' => 'form-control py-20 px-15'
                                            ]) ?>
                                        </div> -->
                                    ...
                                    <div class="tab-pane font-family-roboto fade <?=$class_disabler ? 'show active' : ''?> " id="pill-3" role="tabpanel" aria-labelledby="pill-3-tab">
                                        <div class="form-group mb-25">
                                            <?= $form->field($model, 'unit_id')->dropDownList(ArrayHelper::map(Unit::find()->join('left join', "unit_translate", 'unit.id = unit_translate.unit_id and unit_translate.lang = :lang', [':lang' => Yii::$app->languageId->id])->orderBy('unit_translate.title asc')->all(), 'id', 'title'), [
                                                'class' => 'form-control px-15'
                                            ]) ?>
                                        </div>
                                        <div class="form-group mb-25">
                                    ...
                                    <div class="tab-pane font-family-roboto fade" id="pill-4" role="tabpanel" aria-labelledby="pill-4-tab">
                                        ...
                                        <div class="form-group mb-25">
                                            <?= $form->field($model, 'delivery_regions')->dropDownList(
                                                Region::getTree(),
                                                [
                                                    'class' => 'form-control px-15 select2',
                                                    'multiple' => true
                                                ]
                                            ) ?>
                                        </div>
                                    ...
                                    <div class="tab-pane font-family-roboto fade" id="pill-5" role="tabpanel" aria-labelledby="pill-5-tab">
                                        ...
                                        <div class="form-group mb-0">
                                            <?= Html::submitButton($model->isNewRecord ? t('Добавить товар') : t("Редактировать"), ['class' => 'btn btn-success float-right my-4']); ?>
                                        </div>
                                    </div>
                                </div>
...
function checkDelivery (){
    if ($("#product-delivery_type").val() == 2){
        ...
        $(".field-product-delivery_address").fadeIn(200);
    } else {
        $(".field-product-delivery_regions").fadeIn(200);
        $(".field-product-delivery_address").fadeOut(200);
    }
}
