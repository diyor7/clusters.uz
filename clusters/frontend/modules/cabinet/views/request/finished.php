        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <ul class="nav nav-cabinet fs-15">
                    ...
                    <li class="nav-item position-relative pb-30 mx-15">
                        <a class="nav-link p-0 active" href="<?= toRoute('/cabinet/request/finished') ?>">
                                ...
                                <div class="item shadow bg-white rounded mb-10 wow fadeInUp">
                                    <div class="item__head py-15 px-20 ">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col-2 text-center">
                                                <?= showPrice($order->actual_price) ?> <?= t("сум") ?>
                                            </div>
                                            ...
                                            <table class="table mb-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center"><?= t("Актуальная цена за ед.") ?></th>
                                                ...
                                                <tbody>
                                                    <?php foreach ($order->orderLists as $index => $order_list) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?= showPrice($order->actual_price) ?> <?= t("сум") ?></td>
                                                            <td class="text-right"><?= showPrice($order_list->quantity * $order->actual_price) ?> <?= t("сум") ?></td>
                                                        </tr>
                                                    <?php endforeach ?>
                                                </tbody>
                                            </table>
