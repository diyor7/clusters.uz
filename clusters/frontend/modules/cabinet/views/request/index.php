            ...
            <div class="col-md-9">
                <ul class="nav nav-cabinet fs-15">
                    <li class="nav-item position-relative pb-30 mr-15">
                        <a class="nav-link p-0" href="<?= toRoute('/cabinet/request/waiting') ?>">
                    ...
                    <li class="nav-item position-relative pb-30 mx-15">
                        <a class="nav-link p-0 active" href="<?= toRoute('/cabinet/request') ?>">
                    ...
                    <div class="i-list__head px-20 mb-20">
                        <div class="row no-gutters">
                            ...
                            <div class="col-3 text-center">
                                <div class="i-list__sortable"><?= t("Наименования товара") ?></div>
                            </div>
                            ...
                            <div class="col-2 text-center">
                                <div class="i-list__sortable"><?= t("Дата начало и окончания") ?></div>
                            </div>
                            <div class="col-1 text-center">
                                <div class="i-list__sortable"> <?= t("Мое предложение") ?></div>
                            </div>
                                ...
                                <div class="item shadow bg-white rounded mb-10 wow fadeInUp">
                                    <div class="item__head py-15 px-20 ">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-1">
                                                <a href="<?= toRoute('/cabinet/request/' . $order->id) ?>" class="item__name"><b>№ <?= $order->id ?></b></a>
                                            </div>
                                            <div class="col-3 text-center">
                                            ...
                                            <div class="col-1 text-center">
                                                <?php if ($order->myRequest) : ?>
                                                    <?= showPrice($order->myRequest->price) ?> <?= t("сум") ?>
                                                <?php else : ?>
                                                    <?= t("(не указано)") ?>
                                                <?php endif ?>
                                            </div>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col text-right">
                                                        <div class="collapse-btns">
                                                            ...
                                                            <a class="btn btn-secondary px-20 py-5 fs-15 mr-5" href="<?= toRoute('/cabinet/request/' . $order->id) ?>">
                                                                <?= t("Предложить") ?>
                                                            </a>
