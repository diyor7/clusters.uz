...
$this->params['breadcrumbs'][] = array(
    'label' => t("Договоры"),
    'url' => toRoute('/cabinet/contract')
);
$this->params['breadcrumbs'][] = $this->title;
?>
<?= $this->render("../layouts/_nav", [
    'btn_title' => t("Назад"),
    'btn_url' => toRoute('/cabinet/contract'),
    'breadcrumb_title' => t("Договоры"),
    'breadcrumb_url' => toRoute('/cabinet/contract')
]) ?>
                                    ...
                                    <?php if($model->order): ?>
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?= t("Наименование товара") ?></th>
                                                <th><?=t("Код ТН ВЭД")?></th>
                                                <th><?= t("Количество") ?></th>
                                                <th><?= t("Предложенная цена за ед.") ?></th>
                                                <th><?= t("Сумма") ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($model->order->orderLists as $index => $order_list) : ?>
                                                <tr>
                                                    <td><?= $index + 1 ?></td>
                                                    <td>
                                                    ...
                                                    <td class="text-center"><?= $order_list->product->code ?></td>
                                                    <td class="text-center"><?= $order_list->quantity ?></td>
                                                    <td class="text-center"><?= showPrice($model->order->winner->price) ?> <?= t("сум") ?></td>
                                                    <td class="text-right"><?= showPrice($order_list->quantity * $model->order->winner->price) ?> <?= t("сум") ?></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
