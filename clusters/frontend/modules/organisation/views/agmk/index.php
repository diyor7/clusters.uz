...
<!--        <h1 class="page-title font-weight-bold fs-36 pb-25" id="page-name"></h1>-->
            <ul class="nav mb-45 category__types">
                <li class="nav-item <?=$type==0?'active':''?>">
                    <a href="<?=Url::to(['/organisation/agmk/index', 'id' => $company->id, 'type' => 0])?>" class="nav-link px-0 mr-15 fs-24 fw-semi-bold"><?php echo Yii::t('frontend', "Импорт");?></a>
                </li>
                <li class="nav-item <?=$type==2?'active':''?>">
                    <a href="<?=Url::to(['/organisation/agmk/index', 'id' => $company->id, 'type' => 2])?>" class="nav-link px-0 mr-15 fw-semi-bold fs-24"><?php echo Yii::t('frontend', "Местные закупки");?></a>
                </li>
                <li class="nav-item <?=$type==1?'active':''?>">
                    <a href="<?=Url::to(['/organisation/agmk/index', 'id' => $company->id, 'type' => 1])?>" class="nav-link px-0 fs-24 fw-semi-bold"><?php echo Yii::t('frontend', "Выпускаймая продукция");?></a>
                </li>
            </ul>
            <div>
                <?php if ($type==1):?>
                            ...
                            <div class="item rounded-lg position-relative d-flex align-items-center p-20 wow fadeInUp">
                                ...
                                <div class="item__content">
                                    <div class="item__name">
                                        <a href="<?=Url::to(['/organisation/agmk/products', 'id' => $company->id, 'category_id' => $category->id, 'type' => $type])?>" class="item__link stretched-link"><?=$category->name?></a>
                                    </div>
