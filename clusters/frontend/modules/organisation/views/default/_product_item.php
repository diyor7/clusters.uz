...
<tr>
    <td >
        <a href="<?=Url::to(['/organisation/default/product', 'id' => $product->id, 'type' => $type])?>" class="black-link d-flex align-items-center">
            <img src="<?=$company->link?><?=$product->image?>" alt="" width="100" class="float-left mr-10">
