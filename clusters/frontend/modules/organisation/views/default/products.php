...
<div class="container z-index-1 bg-white position-relative px-40 mb-35 py-35 mt-50 overflow-hidden">
    ...
    <section class="pt-0 mb-60 pb-0 category">
        ...
        <div class="breadcrumb black-link bg-transparent fw-semi-bold fs-18">
            <?php if ($type != 1):?>
                <a href="<?=Url::to(['/organisation/default/index', 'id' => $company->id])?>"><?php echo Yii::t('frontend', "Закупки");?></a> &#8212;
            <?php endif;?>
