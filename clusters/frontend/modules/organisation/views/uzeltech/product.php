...
<div class="new-bg-different">
    <div class="container py-30">
        ...
        <div class="new-breadcrumbs d-flex align-items-center">
            ...
            <?php elseif($type==1):?>
                <a href="<?=Url::to(['/organisation/uzeltech/index', 'id' => $company->id, 'type' => 1])?>"><?php echo Yii::t('frontend', "Выпускаймая продукция");?></a>
            <?php else:?>
                <a href="#"><?=$this->title?></a>
            <?php endif;?>
            <span></span>
            <a href="<?=Url::to(['/organisation/uzeltech/products', 'id' => $company->id, 'category_id' => $category->id, 'type' => $type])?>"><?= $category->name ?></a>
            <span></span>
            <p><?= $this->title ?></p>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        ...
                        <dl class="mt-30 pb-30">
                            ...
                            <dt><?php echo Yii::t('frontend', "Потребность в год"); ?>:</dt>
                            <dd> <?= $product->need_year ?> <?=$product->units_measure_id?></dd>
