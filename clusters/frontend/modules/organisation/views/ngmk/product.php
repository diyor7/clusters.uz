...
<div class="new-bg-different">
    <div class="container py-30">
        ...
        <div class="new-breadcrumbs d-flex align-items-center">
            ...
            <?php endif;?>
            <span></span>
            <a href="<?=Url::to(['/organisation/ngmk/products', 'id' => $company->id, 'category_id' => $category->id, 'type' => $type])?>"><?= $category->name ?></a>
            <span></span>
            <p><?= $this->title ?></p>
        </div>
    </div>
...
<div class="container z-index-1 bg-white position-relative px-40 mb-35 py-35 mt-50 overflow-hidden">
    ...
    <section class="pt-0 mb-60 pb-0 category">
        ...
        <div class="category__product product-info row pt-35">
            <div class="col-9">
                <div class="row">
                    <div class="col-5">

                        <div id="gallery" class="d-block product-info__gallery owl-carousel owl-theme position-relative">
                                <?php if(!empty($product->images)){ foreach ($product->images as $image):?>
                                    <div class="item rounded-lg" style="background-image: url('/organisations/<?=$company->folder?><?='/uploads/images/products/'.$image->value?>')">
                                        <a href="/organisations/<?=$company->folder?><?='/uploads/images/products/'.$image->value?>" class="stretched-link gallery-popup-link">
