...
<div class="new-bg-different">
    <div class="container py-30">
        ...
        <div class="new-breadcrumbs d-flex align-items-center">
            ...
            <span></span>
            <a href="<?= Url::to(['/organisation/umk/index', 'id' => $company->id, 'type' => 0]) ?>">Потребность</a>
            <span></span>
            <a href="<?= Url::to(['/organisation/umk/products', 'id' => $company->id, 'type' => $type, 'category_id' => $category->id]) ?>"><?= $category->name ?></a>
            <span></span>
            <p><?= $this->title ?></p>
        </div>
    </div>
