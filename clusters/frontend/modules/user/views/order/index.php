            ...
            <div class="col-md-9">
                <ul class="nav nav-cabinet fs-15">
                    <li class="nav-item position-relative   pb-30 mr-15">
                        <a class="nav-link active <?= $status != "finished" ? 'active' : '' ?> p-0" href="<?= toRoute('/user/order') ?>"><?= t("Активные заявки") ?> (<?= $active_count ?>)</a>
                    </li>
                    <li class="nav-item position-relative pb-30 mx-15">
                        <a class="nav-link p-0 <?= $status == "finished" ? 'active' : '' ?>" href="<?= toRoute('/user/order?status=finished') ?>"><?= t("Завершенные заявки") ?> (<?= $finished_count ?>)</a>
                    </li>
                </ul>
                                ...
                                <div class="item shadow bg-white rounded mb-10 wow fadeInUp">
                                    <div class="item__head py-15 px-20 ">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-2">
                                                <a href="<?= toRoute('/user/order/' . $order->id) ?>" class="item__name"><b>№ <?= $order->id ?></b> / <span><?= date("d.m.Y H:i", strtotime($order->created_at)) ?></span></a>
                                            </div>
                                            <div class="col text-center">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-right">
                                                        <div class="collapse-btns">
                                                            ...
                                                            <a href="<?= toRoute('/user/order/' . $order->id) ?>" class="btn btn-primary px-20 py-5 fs-15 mr-5"><?= t("Посмотреть") ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
