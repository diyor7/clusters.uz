                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col text-right">
                                                        <div class="collapse-btns">
                                                            ...
                                                            <?php if (!$model->customer_signed) : ?>
                                                                <a class="btn btn-secondary px-20 py-5 fs-15" data-confirm="<?= t("Вы уверены?") ?>" <?= $model->customer ? 'data-sign="true" data-tin="' . $model->customer->tin . '"' : '' ?> href="<?= toRoute('/' . Yii::$app->controller->module->id . '/contract/accept?id=' . $model->id) ?>"><?= t("Подписать") ?></a>
                                                            <?php else : ?>
                                                                <span>
                                                                    <?= t("Вы подписали") ?>
                                                                </span>
