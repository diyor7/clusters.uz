                                                    ...
                                                    <tbody>
                                                        <?php foreach ($model->order->orderLists as $index => $model_list) : ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><?= $model->order->winner ? showPrice($model->order->winner->price) : 0 ?> <?= t("сум") ?></td>
                                                                <td class="text-right"><?= $model_list && $model->order->winner ?  showPrice($model_list->quantity * $model->order->winner->price) : 0 ?> <?= t("сум") ?></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col text-right">
                                                        <div class="collapse-btns">
                                                            ...
                                                            <a class="btn btn-secondary px-20 py-5 fs-15 mr-5" <?= $model->customer ? 'data-sign="true" data-tin="' . $model->customer->tin . '"' : '' ?> data-confirm="<?= t("Вы точно хотите оплатить?") ?>" href="<?= toRoute('/' . Yii::$app->controller->module->id . '/contract/pay?id=' . $model->id) ?>"><?= t("Оплатить") ?></a>
                                                            <a class="btn btn-danger px-20 py-5 fs-15" data-confirm="<?= t("Вы точно хотите расторгнуть?") ?>" href="<?= toRoute('/' . Yii::$app->controller->module->id . '/contract/cancel?id=' . $model->id) ?>"><?= t("Расторгнуть") ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
