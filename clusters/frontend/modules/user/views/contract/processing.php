            ...
            <div class="col-md-9">
                <ul class="nav nav-cabinet fs-15">
                    ...
                    <li class="nav-item position-relative  pb-30 mx-15">
                        <a class="nav-link p-0 " href="<?= toRoute('/' . Yii::$app->controller->module->id . '/contract/waiting') ?>">
                    ...
                    <li class="nav-item position-relative  pb-30 mx-15">
                        <a class="nav-link p-0 active" href="<?= toRoute('/' . Yii::$app->controller->module->id . '/contract/processing') ?>">
                    ...
                    <div class="i-list__head px-20 mb-20">
                        <div class="row no-gutters">
                            ...
                            <div class="col text-center">
                                <div class="i-list__sortable"><?= t("Поставщик") ?></div>
                            </div>
                                ...
                                <div class="item shadow bg-white rounded mb-10 wow fadeInUp">
                                    <div class="item__head py-15 px-20 ">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col text-center">
                                                <a target="_blink" href="<?= toRoute(['/producers/' . $model->producer->link]) ?>" class="item__name d-inline-block">
                                                    <?= $model->producer->name ?>
                                                </a>
                                            ...
                                            <div class="col-2 text-center">
                                                <span class="item__badge <?= $model->statusClass ?> d-inline-block">
                                                    <?= t("Оплачено.") ?> <br>

                                                    <?php $delivery_period = -1; ?>
                                                    <?php $delivery_period_type = -1; ?>

                                                    <?php foreach ($model->order->orderLists as $index => $model_list) : ?>
                                                        <?php $delivery_period = $delivery_period < $model_list->cacheProduct['delivery_period'] ? $model_list->cacheProduct['delivery_period'] : $delivery_period ?>
                                                        <?php $delivery_period_type = $delivery_period_type < $model_list->cacheProduct['delivery_period_type'] ? $model_list->cacheProduct['delivery_period_type'] : $delivery_period_type ?>
                                                    <?php endforeach ?>

                                                    <?= t("Последний день поставки") ?>: <?= date("d.m.Y", strtotime("+" . $delivery_period . ' ' . ($delivery_period_type == Product::DELIVERY_PERIOD_TYPE_DAY ? 'day' : ($delivery_period_type == Product::DELIVERY_PERIOD_TYPE_MONTH ? "month" : "year")))) ?>
                                                </span>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col text-right">
                                                        <div class="collapse-btns">
                                                            ...
                                                            <a class="btn btn-secondary px-20 py-5 fs-15 mr-5" data-sign="true" data-tin="<?= $model->customer->tin ?>" data-confirm="<?= t("Вам товары поставлены?") ?>" href="<?= toRoute('/' . Yii::$app->controller->module->id . '/contract/mark-delivered?id=' . $model->id) ?>">
                                                                <?= t("Товары поставлены") ?>
                                                            </a>
