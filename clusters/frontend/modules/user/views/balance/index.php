        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="d-balance-info mb-30">
                    ...
                    <a href="<?= toRoute('/' . Yii::$app->controller->module->id . '/balance/visibility') ?>" class="text-414141 d-inline-block text-underline mt-25 fs-14"><?= $company_balance->show_balance === 1 ? t("Скрыть баланс") : t("Показать баланс") ?></a>
                </div>
