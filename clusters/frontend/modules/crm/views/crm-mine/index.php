...
/* @var $searchModel common\models\crm\CrmMineSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('crm', 'Crm Mines');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="crm-mine-index">
    <?= $this->render("../layouts/_nav", [
        'btn_title' => t("Добавить Ископаемые"),
        'btn_url' => toRoute('/crm/crm-mine/create')
    ]) ?>
