...
/* @var $searchModel common\models\crm\CrmEquipmentsUsedSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
/* @var $type_id int */

$this->title = Yii::t('crm', 'Crm Equipments Useds');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="crm-equipments-used-index">
    <?= $this->render("../layouts/_nav", [
        'btn_title' => t("Добавить использованнние оборудование"),
        'btn_url' => toRoute(['/crm/crm-equipments-used/create', 'type_id' => $type_id])
    ]) ?>
...
//                            'type',
                            [
                                ...
                                'filter' =>  \common\models\crm\CrmEquipmentsUsed::getEquipments()
                            ],
                            'count',
                            'lifetime',
                            'created_at:datetime',
