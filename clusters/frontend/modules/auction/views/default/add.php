                    ...
                    <div class="tab-content pt-15 mt-15 pb-15" id="pills-tabContent">
                        <div class="tab-pane font-family-roboto fade show active" id="pill-1" role="tabpanel" aria-labelledby="pill-1-tab">
                            ...
                            <div id="root">
                                ...
                                <div id="condition_box" class="form-group mb-25 border-top-1 p-1 border-dark">
                                    <p class="p-10 text-dark"><?=t("Особые условия")?></p>
                                    <!--                                    <div id="condition_box" class="p-10 background-gainsboro my-2 d-flex justify-content-between">-->
                                    <!--                                        <p class="m-0">-->
                                    <!--                                            Базисные условия поставки: - железнодорожным транспортом за счет «Покупателя» - Погрузка осуществляется средствами Продавца, за счёт Продавца-->
                                    <!--                                        </p>-->
                                    <!--                                        <p class="m-0 x_cancel-box"><button href="" class="x_cancel  b-radius-50 px-2 py-1 ">X</button></p>-->
                                    <!--                                    </div>-->
                                ...
                                <div class="form-group bt-25 mb-55">
                                    <div class="my-15" style="height: 350px; overflow-y: scroll; padding: 10px; border: 3px solid #f8f8f8">
                                        <div class="row mx-0">
                                            <?= ''; //$form->field($model, 'condition_ids')->checkboxList(ArrayHelper::map(Condition::find()->all(), 'id', 'title'), ['class' => 'background-gainsboro '])->label("Особые условия") 
                                            ?>
                                            <?php foreach (Condition::find()->all() as $md) : ?>
                                                <div class="checkbox px-3 py-2 background-gainsboro my-1 w-100 b-radius-5">
                                                    <label class="m-0">
                                                        <input type="text" class="condition_checkbox" name="Auction[condition_ids][]" value="<?= $md->id ?>" data-title="<?= htmlspecialchars($md->title) ?>">
                                                        <?= $md->title ?>
                                                    </label>
                                                </div>
                                            <?php endforeach; ?>
